...
def get_scenario_text(current_topic,username,api_key):
	...
	CHILLGUY: Is a talking animated dog who’s always chill
	PUPPET: Is a character drawn in Paint. He's funny, swears a lot, and thinks he's better than everyone else.
